...
//! [`crate::data_rpc`] and [`crate::ctl`]. Connection framing, accept
//! loops, and request cancellation live in [`serve`]; this module owns
//! bind, ready publication, and ordered teardown.
//!
...
pub use serve::LineHandler;
#[cfg(test)]
pub(crate) use serve::{BlockingQueryStartBarrier, with_request_cancellation};
pub(crate) use serve::{
    RequestCancelTarget, RequestCancelTargetGuard, RequestCancellation, RequestDrainGuard,
